...
|-----|------|----------|-------------|
| `control` | [IControl](https://maplibre.org/maplibre-gl-js/docs/API/interfaces/IControl/) \| EventedControl | Yes | A MapLibre IControl instance. Controls that extend Evented (e.g. `GeolocateControl`) support event binding via the yielded `on` component. |
