...
import { Marker, Popup, type PopupOptions, type LngLatLike, type Map as MaplibreMap } from 'maplibre-gl';
...
export default class MapLibreGLPopup extends Component<MapLibreGLPopupSignature> {
    ...
    /** @internal */
    updatePopupLngLat: (lngLat: MapLibreGLPopupSignature["Args"]["lngLat"]) => void;
}
//# sourceMappingURL=maplibre-gl-popup.d.ts.map