...
export default class MapLibreGLImage extends Component<MapLibreGLImageSignature> {
    ...
    /** @internal */
    _onImage: (url: MapLibreGLImageSignature["Args"]["url"], name: MapLibreGLImageSignature["Args"]["name"], options?: MapLibreGLImageSignature["Args"]["options"], image?: Parameters<MaplibreMap["addImage"]>[1]) => void;
    /** @internal */
